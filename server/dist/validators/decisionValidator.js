...
exports.validateUpdateDecision = exports.validateCreateDecision = void 0;
const validateCreateDecision = (data) => {
    const errors = [];
    const dto = data;
    // Validar title
    ...
    if (dto.selectedOption !== undefined) {
        ...
        else if (typeof dto.selectedOption === 'string' &&
...
const validateUpdateDecision = (data) => {
    const errors = [];
    const dto = data;
